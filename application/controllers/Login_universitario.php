...
class Login_universitario extends CI_Controller {
	...
	public function logar() {
		...
		$this->form_validation->set_rules('apelido', 'apelido', 'trim|required|alpha_numeric_spaces|min_length[4]|max_length[100]');
		...
		if ($this->universitarios->existe_apelido_e_senha($apelido, $senha)) {
			...
			$this->universitarios->setar_sessao_apelido($sessao);
